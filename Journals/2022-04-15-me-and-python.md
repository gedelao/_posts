...
To define Python is in short abbreviation, Python is a computer programming language often used to build websites and software, automate tasks, and conduct data analysis. A popular programing language that Data analysis and machine learning Web development, Automation or scripting, Software testing, prototyping and used for everyday tasks! After completing Python, I can honestly say that the process was a mixed bag. Being able to use print, if, input, return, break and etc. 
